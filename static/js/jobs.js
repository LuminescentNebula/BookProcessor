...
const statuses = {queued:'В очереди',processing:'Распознавание',normalizing:'Повторная обработка с интернет-поиском',saving:'Сохранение',waiting_database:'Ожидание PostgreSQL',completed:'Готово',failed:'Ошибка'};
